...
export {getUser, getUserData, getUserDeck, updateName, removeFromBattle, addToBattle, isLogged, signOut, signIn, signUp, pending, getBid, matchmaking, isFighting, getBattleDecks};